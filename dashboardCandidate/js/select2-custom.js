$(document).ready(function() {
    ...
    let $select2 = $(".province").select2(optionSelect2);
    ...
    $(document).on("click", "#all-branch",function(){
        $(".province > option").not(':first').prop("selected", true);// Select All Options
    ...
    $(document).on("click", "#clear-branch", function(){
    	$(".province > option").not(':first').prop("selected", false);
    	$(".province").trigger("change");
